...
Em geral, todos os casos armazenam os elemento de fronteira ficam armazenados em tuplas (estado, informacoes de acoes [custo acumulado etc])
...
O teste do IsGoalState pode ser verificado ao checar se todos os cantos estão associados ao booleano True, assim garantindo o fim. Além disso, é possível checar os estados futuros ao verificar os cantos ainda não visitados e a posição atual do pacman.
